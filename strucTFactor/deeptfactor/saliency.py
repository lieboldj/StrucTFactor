...
def analyzeRow(j, i, regions, gradients, spatial):
    if spatial:
...
def analyzeGradient(j, i, gradients, spatial):
    if spatial:
        aa_vocab = ['A_a', 'A_b', 'A_N', 'C_a', 'C_b', 
            'C_N', 'D_a', 'D_b', 'D_N', 'E_a', 
            'E_b', 'E_N', 'F_a', 'F_b', 'F_N', 
...
# found this (maybe useful?) https://github.com/kazuto1011/grad-cam-pytorch/blob/master/main.py