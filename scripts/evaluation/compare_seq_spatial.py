...
mode = ["seq", "spatial"]
exps = ["CV_AFfiltered_expTFs_clu"]#,"CV_AFfiltered_expTFs_clu"]
...
plt.title("Comparison of seq and spatial models for {}".format(exp.split('_')[1]))

plt.savefig(f"../plots/scatter_{exp.split('_')[1]}.png", bbox_inches='tight')
print(f"../plots/scatter_{exp.split('_')[1]}.png")
